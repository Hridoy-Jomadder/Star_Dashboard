...
// Include database connection code in a separate file
...
// Retrieve the user's profile photo from the database using dynamic user ID
$profile_image = getprofile_image($id, $conn);
