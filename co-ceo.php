...
// Fetch CO-CEO information from the database
$co_ceo_data = $DB->fetchCo_CEOData();

// Check if the CO-CEO data is found
if (!$co_ceo_data) {
    // Handle the case where the CO-CEO data is not found
    echo "CO-CEO data not found.";
    exit();
}

// Extract CO-CEO information from the fetched data
$profile_image = $co_ceo_data['profile_image'];
$full_name = $co_ceo_data['full_name'];
$user_role = $co_ceo_data['user_role'];
$email = $co_ceo_data['email'];
$join_date = $co_ceo_data['join_date'];
?>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="co-ceo.php" class="dropdown-item active">Co-CEO</a>
